    ...
    <div id="poststuff">
        <div id="ph-gallery-wp-gallerys-list-page">
            ...
            <div class="photo_gallery_wp_search_pagination_banner">
                <form name="photo_gallery_wp_search_album" action="admin.php" method="GET">
                    <div class="photo_gallery_wp_album" style="vertical-align: middle; display: inline-block">
                        <input type="hidden" name="page" value="photo_gallery_wp_album">
                        ...
                        <a style="display: inline-block; vertical-align: middle;" class="add-new-h2"
                           href="admin.php?page=photo_gallery_wp_albums">Reset</a>
                    </div>
